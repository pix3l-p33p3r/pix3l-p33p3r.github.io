...
export default function About() {
  ...
  return (
    <section id="about" className="mb-8 pb-5 border-b border-dashed border-[#333] last:border-b-0" style={{ height: "100%" }}>
      ...
      <div
        ref={terminalRef}
        className="font-mono text-[#00ffff] text-base md:text-2xl leading-relaxed mt-4 overflow-hidden relative p-4 md:p-7 bg-black/50 border border-[#333] shadow-[inset_0_0_20px_rgba(0,255,255,0.2)] rounded"
